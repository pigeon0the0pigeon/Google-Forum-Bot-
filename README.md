...
Download the file and the requirments file, then run pip install -r requirements.txt, bot should be able to run after that.
If you wish to make edits and then compile it I would reccomend pyinstaller that's what I used to compile it.
